...
def create_document(doc_id: str, content: str, metadata: Dict = None) -> Dict:
    ...
    data = {"id": doc_id, "content": content, "metadata": metadata or {}}
...
def search_documents(query: str, n_results: int = 5) -> Dict:
    ...
    data = {"query_text": query, "n_results": n_results}
...
def main():
    ...
    documents = [
        ...
        {
            "id": "doc_ml_basics",
            "content": "Machine Learning is a subset of AI that enables systems to "
            "learn and improve from experience without being explicitly programmed.",
            "metadata": {"category": "ML", "level": "beginner", "author": "Demo"},
        },
        {
            "id": "doc_dl_neural",
            "content": "Deep Learning uses neural networks with multiple layers to "
        ...
        },
        {
            ...
            "content": "Transformers revolutionized NLP by introducing self-attention "
            "mechanisms, enabling models like BERT and GPT to understand "
            "context better.",
    ...
    for doc in documents:
        try:
            create_document(doc["id"], doc["content"], doc["metadata"])
    ...
    for i, (doc_id, content, distance) in enumerate(
        zip(
            search_results["ids"],
    ...
    # Cleanup (optional)
    print(
        "\n7. Cleanup (press Enter to delete all demo documents, "
        "or Ctrl+C to keep them)"
    )
    try:
        input()
        for doc in documents:
